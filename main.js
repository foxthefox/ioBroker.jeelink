...
class Jeelink extends utils.Adapter {
    ...
    async onReady() {
        ...
        let baudrate = this.config.baudrate || 57600;
     ...
     *
     * @param {() => void} callback - keine Ahnung
     */
    ...
    async logemonWater(data) {
        ...
        if (tmp[0] === 'OK') {
            ...
            if (array.length === 0 || array.length !== 1) {
                this.log.debug(`received ID :${tmp[2]} is not defined in the adapter or not unique received address`);
    ...
    async logHMS100TF(data) {
        ...
        if (tmp[0] === 'H') {
            ...
            if (array.length === 0 || array.length !== 1) {
                ...
                this.log.debug(`Humidty      : ${parseInt(tmp[11]) * 10 + parseInt(tmp[12]) + parseInt(tmp[9]) / 10}`);
    ...
    async logEMT7110(data) {
        ...
        if (tmp[0] === 'OK') {
            ...
            if (tmp[1] == 'EMT7110') {
                ...
                if (array.length === 0 || array.length !== 1) {
                    this.log.debug(`received ID :${id} is not defined in the adapter or not unique received address`);
        ...
        if (tmp[0] === 'OK') {
            ...
            if (tmp[1] == 'WS') {
                ...
                if (array.length === 0 || array.length !== 1) {
                    ...
                    this.log.debug(`received ID :${parseInt(tmpp[0])} is not defined in the adapter as LaCrosseWS`);
                } else if (array[0].usid != 'nodef') {
        ...
        if (tmp[0] === 'OK') {
            ...
            if (tmp[1] == 'WS') {
                ...
                if (array.length === 0 || array.length !== 1) {
                    ...
                    this.log.debug(`received ID :${parseInt(tmpp[0])} is not defined in the adapter as LaCrosseBMP180`);
                } else if (array[0].usid != 'nodef') {
                    this.log.debug(`Sensor ID    : ${parseInt(tmpp[0])}`);
                    this.log.debug(`Type         : ${parseInt(tmpp[1])}`);
                    this.log.debug(`Temperatur   : ${(parseInt(tmpp[2]) * 256 + parseInt(tmpp[3]) - 1000) / 10}`);
    ...
    async logDavisVantage(data) {
        ...
        if (tmp[0] === 'OK') {
            ...
            if (tmp[2] == 'DAVIS') {
                ...
                if (array.length === 0 || array.length !== 1) {
                    this.log.debug(
                        `received ID :${parseInt(tmp[3])} is not defined in the adapter or not unique received address`,
                    );
                } else if (array[0].stype !== 'DavisVantage') {
                    this.log.debug(`received ID :${parseInt(tmp[3])} is not defined in the adapter as DavisVantage`);
                } else if (array[0].usid != 'nodef') {
